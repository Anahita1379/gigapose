...
gigaPose_datasets/results/last_picks/large_assettocorsa_IST_AE_benchmark_with_max_depth/predictions/large-pbrreal-rgb-mmodel_assettocorsa_benchmark_with_max_depth-test_assettocorsa_IST_AE_benchmark_with_max_depthMultiHypothesis.csv
...
--split test \
--rendered-iou \
--output-dir gigaPose_datasets/results/last_picks/metrics/all_model
```
