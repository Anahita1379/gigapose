"""Reselect tracked poses using optimized metadata camera/LiDAR extrinsics.
...
EXTRINSICS_SELECTOR = (
    "fine_tuning.select_real_label_candidates_with_camera_lidar_extrinsics"
)
OUTPUT_CSV_NAMES = (
...
def parse_args(
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "run the metadata camera/LiDAR-extrinsics real-label selector. "
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "optimized_extrinsics.json (or its directory) produced by "
            "fine_tuning.optimize_camera_lidar_extrinsics."
        ),
    )
    parser.add_argument(
